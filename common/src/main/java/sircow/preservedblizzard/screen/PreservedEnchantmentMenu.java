package sircow.preservedblizzard.screen;
...
public class PreservedEnchantmentMenu extends AbstractContainerMenu {
    ...
    public static final List<EnchantmentInfo> ENCHANTMENT_DATA = List.of(
            ...
            new EnchantmentInfo("Luck Of The Sea", "20", Enchantments.LUCK_OF_THE_SEA),
            new EnchantmentInfo("Lure", "20", Enchantments.LURE),
